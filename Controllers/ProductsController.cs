    ...
    public class ProductsController : Controller
    {
        ...
        private List<ProductModel>? GetSampleProducts()
        {
            return new List<ProductModel>
            {
                ...
                Description = "Great support in this high-top to take you to great heights and" +
                " trails."},
                new ProductModel { Id=2, Name = "Coastliner", Price = 49.99M, IsActive = true,
                Description = "Easy in and out with this lightweight but rugged shoe with great" +
                " ventilation to get..."},
                new ProductModel { Id=3, Name = "Woodsman", Price = 64.99M, IsActive = true,
                Description = "All the insulation and support you need when wandering the rugged" +
                " trails of the woods."},
                new ProductModel { Id=4, Name = "Basecamp", Price = 249.99M, IsActive = true,
                Description = "Great insulation and plenty of room for 2 in this spacious but" +
                " highly-portable tent..."}
            };
        }
